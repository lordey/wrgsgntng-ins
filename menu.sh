...
echo -e  "\e[033;1mx menampilkan command list/daftar perintah [menu]"  
echo -e  "\e[034;1mx membuat akun baru [usernew]"  
echo -e  "\e[035;1mx membuat akun trial berdurasi 1 hari [trial]"  
echo -e  "\e[036;1mx mengahpus akun ssh [hapus]"  
echo -e  "\e[031;1mx memeriksa user yang login [cek]"  
echo -e  "\e[032;1mx memeriksa daftar user [member]"  
echo -e  "\e[033;1mx restart service dropbear, webmin, squid3, ssh, & OpenVPN [resvis]"  
echo -e  "\e[034;1mx reboot server [reboot]"  
echo -e  "\e[035;1mx test speed server [speedtest]" 
echo -e  "\e[036;1mx informasi server [info]"  
echo -e  "\e[036;1mx informasi script [about]"  
echo -e  "\e[037;1m************************************" 
